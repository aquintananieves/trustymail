            ...
            for tag in tag_dict:
                if tag not in ['v', 'mailto', 'rf', 'p', 'sp', 'adkim', 'aspf', 'fo', 'pct', 'ri', 'rua', 'ruf']:
                    ...
                    try:
                        ...
                        if pct < 100:
                            msg = 'Warning: The DMARC pct tag value may be less than 100 (the implicit default) during ' \
                                    'deployment, but should be removed or set to 100 upon full deployment'
